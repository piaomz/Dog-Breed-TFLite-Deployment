...
public abstract class Classifier {
  ...
  public static Classifier create(Activity activity, Model model, Device device, int numThreads)
    ...
    } else if (model == Model.DOG_NET_AUTOML) {
      return new ClassifierDogNet(activity, device, numThreads);
    }else if (model == Model.DOG_NET_KERAS) {
      return new ClassifierDogNetKeras(activity, device, numThreads);
    }else{
